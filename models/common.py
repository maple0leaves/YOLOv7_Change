...
#author 221 create
#create a new Conv ,make common Conv last output to SE
...
class SEBlock(nn.Module):
    ...
    def forward(self, x):
        ...
        return x * y.expand_as(x)# 矩阵扩展 https://blog.csdn.net/weixin_43102043/article/details/125031909
